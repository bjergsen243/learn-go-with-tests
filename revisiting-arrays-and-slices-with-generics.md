...
Hãy xem lại `SumAll` và `SumAllTails` mà chúng ta đã viết trong chương [array và slice](arrays-and-slices.md). Nếu chưa có, hãy sao chép code và test từ chương đó.
