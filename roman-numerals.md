...
Chúng ta thấy có sự lặp lại trong các bản kiểm thử. Khi bạn đang kiểm thử một thứ gì đó có vẻ như là vấn đề "với đầu vào X, chúng ta mong đợi Y", có lẽ bạn nên sử dụng table-driven test.
